...
const WORDS = [
  'JAVASCRIPT', 'REACT', 'TYPESCRIPT', 'DEVELOPER', 'PROGRAMMING',
  'ALGORITHM', 'DATABASE', 'FRONTEND', 'BACKEND', 'FULLSTACK',
  'ANIMATION', 'COMPONENT', 'INTERFACE', 'DEPLOYMENT', 'OPTIMIZATION',
  'CREATIVE', 'INNOVATION', 'TECHNOLOGY', 'REVOLUTION', 'ADVENTURE'
];
...
const HangmanDrawing = ({ wrongCount }) => {
  const parts = [
    // Head
    <circle key="head" cx="100" cy="60" r="20" className="stroke-red-500 fill-none stroke-[3px] animate-fadeIn" />,
    // Body
    <line key="body" x1="100" y1="80" x2="100" y2="130" className="stroke-red-500 stroke-[3px] animate-fadeIn" />,
    // Left arm
    <line key="leftarm" x1="100" y1="95" x2="75" y2="115" className="stroke-red-500 stroke-[3px] animate-fadeIn" />,
    // Right arm
    <line key="rightarm" x1="100" y1="95" x2="125" y2="115" className="stroke-red-500 stroke-[3px] animate-fadeIn" />,
    // Left leg
    <line key="leftleg" x1="100" y1="130" x2="80" y2="160" className="stroke-red-500 stroke-[3px] animate-fadeIn" />,
    // Right leg
    <line key="rightleg" x1="100" y1="130" x2="120" y2="160" className="stroke-red-500 stroke-[3px] animate-fadeIn" />
  ];
  ...
  return (
    <div className="flex justify-center items-center mb-8">
      <svg width="200" height="200" className="drop-shadow-lg">
        {/* Gallows */}
        <line x1="20" y1="180" x2="120" y2="180" className="stroke-gray-700 stroke-[4px]" />
        <line x1="50" y1="180" x2="50" y2="20" className="stroke-gray-700 stroke-[4px]" />
        <line x1="50" y1="20" x2="100" y2="20" className="stroke-gray-700 stroke-[4px]" />
        <line x1="100" y1="20" x2="100" y2="40" className="stroke-gray-700 stroke-[4px]" />
      ...
      <div className="max-w-4xl w-full bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl p-6 sm:p-10">
        ...
        <div className="flex justify-between items-center mb-8 bg-white/5 rounded-2xl p-4">
          <div className="text-center">
            <div className="text-5xl mb-1 animate-bounce-slow">{getEmoji()}</div>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            ...
            <p className="text-4xl font-black text-white">{MAX_WRONG_GUESSES - wrongGuesses}</p>
          </div>
        </div>
        ...
        <div className="text-center mt-8">
          <button
            onClick={resetGame}
            className="bg-white/10 hover:bg-white/20 text-white px-6 py-2 rounded-full font-semibold text-sm transition-all duration-200 transform hover:scale-105 backdrop-blur-sm"
          >
            Reset Game
          </button>
        </div>
